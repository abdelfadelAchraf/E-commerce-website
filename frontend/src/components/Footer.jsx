  ...
  return (
   <div>
    <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
     <div >
        <img src={assets.Official_logo} alt="logo"className='mb-5 w-32' />
   ...
   <div>
    <hr />
    <p className='py-5 text-sm text-center font-semibold bg-light rounded-md' >&copy; {new Date().getFullYear()} forever. All rights reserved.</p>
   </div>
   </div>
  )
}
